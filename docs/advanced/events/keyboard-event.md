...
In order to use this method, the parameter of the function decorated by [`page`](../../started/how-to-use.md#decorator-page) is obtained through [`data`](../../started/how-to-use.md#datasy-data).
