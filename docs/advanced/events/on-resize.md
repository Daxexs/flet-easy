...
In order to use this event, it is obtained from [`data`](../../started/how-to-use.md#datasy-data) of the function decorated by [`page`](../../started/how-to-use.md#decorator-page).
