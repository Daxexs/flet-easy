...
## Add settings of the `View` controller of [Flet](https://docs.flet.dev/controls/view)

Which can be reused in each of the pages through the [`data:fs.Datasy`](../../started/how-to-use.md#datasy-data) parameter in the `page` decorator function of the app.
...
* The decorator function must receive a mandatory parameter, for example: [`data:fs.Datasy`](../../started/how-to-use.md#datasy-data).
