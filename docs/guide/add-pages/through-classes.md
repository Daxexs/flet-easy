...
* Use the [page](../../started/how-to-use.md#decorator-page) decorator.
* The constructor must have as mandatory parameter [`data:fs.Datasy`](../../started/how-to-use.md#datasy-data) and if it receives a parameter bymeans of the url it must be used as parameter.
