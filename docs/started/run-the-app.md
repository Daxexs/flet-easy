...
To run the application we use an object method already instantiated by [`FletEasy`](how-to-use.md#fleteasy) (you can customize the parameters of method according to your needs :) .
